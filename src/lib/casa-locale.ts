...
const PT = {
  ...
  "alerts.calmNote": "Nada em aberto. Se algo mudar, o aviso chega aqui e ao telemóvel.",
  "alerts.pastError": "Não deu para carregar as ocorrências.",
  ...
  "today.quiet": "Dia calmo até agora.",
  "today.one": "1 ocorrência hoje",
  "today.many": "{n} ocorrências hoje",
  "today.events": "ocorrências",
  ...
  "chart.resolved": "Resolvido",
  "chart.open": "Em aberto",
  ...
  "reports.emptyLead": "Ainda sem relatórios nesta casa.",
  "reports.empty": "Quando a Laro visitar, o relatório aparece aqui.",
  "reports.error": "Não deu para carregar os relatórios.",
  "reports.ok": "Tudo OK",
  "reports.attention": "Atenção",
  "reports.urgent": "Urgente",
  "reports.line.ok": "A casa está bem.",
  "reports.line.attention": "Há algo a acompanhar.",
  "reports.line.urgent": "Precisa de atenção agora.",
  "reports.latest": "Última visita",
  "reports.earlier": "Visitas anteriores",
  "reports.flags": "A acompanhar",
  "reports.covered": "Verificado",
  "reports.proofs": "Fotos da visita",
  "reports.nextVisit": "Próxima visita",
  "reports.seal": "Visita verificada",
  "reports.by": "Visita de {name}",
  "reports.points.one": "1 ponto",
  "reports.points.many": "{n} pontos",
  "reports.photos.one": "1 foto",
  "reports.photos.many": "{n} fotos",
  "reports.photoAlt": "Foto · {item}",
  "reports.photoPrev": "Foto anterior",
  "reports.photoNext": "Foto seguinte",
  "reports.closePhoto": "Fechar foto",
  "reports.check.doors": "Portas",
  "reports.check.windows": "Janelas",
  "reports.check.mail": "Correio",
  "reports.check.air": "Arejar",
  "reports.check.water": "Água",
  "reports.check.lights": "Luzes",
  "reports.check.waste": "Lixo",
  "reports.check.exterior": "Exterior",
  "reports.check.attention": "Atenção",
...
const EN: Record<CasaTextKey, string> = {
  ...
  "alerts.title": "Events",
  "alerts.calmNote": "Nothing open. If something changes, the alert lands here and on your phone.",
  "alerts.pastError": "Could not load the events.",
  "alerts.open": "Open",
  ...
  "today.quiet": "A quiet day so far.",
  "today.one": "1 event today",
  "today.many": "{n} events today",
  "today.events": "events",
  ...
  "reports.emptyLead": "No reports for this house yet.",
  "reports.empty": "When Laro visits, the report shows up here.",
  "reports.error": "Could not load the reports.",
  "reports.ok": "All good",
  "reports.attention": "Needs attention",
  "reports.urgent": "Urgent",
  "reports.line.ok": "The house is fine.",
  "reports.line.attention": "Something to keep an eye on.",
  "reports.line.urgent": "Needs attention now.",
  "reports.latest": "Latest visit",
  "reports.earlier": "Earlier visits",
  "reports.flags": "To follow up",
  "reports.covered": "Checked",
  "reports.proofs": "Photos from the visit",
  "reports.nextVisit": "Next visit",
  "reports.seal": "Visit verified",
  "reports.by": "Visit by {name}",
  "reports.points.one": "1 item",
  "reports.points.many": "{n} items",
  "reports.photos.one": "1 photo",
  "reports.photos.many": "{n} photos",
  "reports.photoAlt": "Photo · {item}",
  "reports.photoPrev": "Previous photo",
  "reports.photoNext": "Next photo",
  "reports.closePhoto": "Close photo",
  "reports.check.doors": "Doors",
  "reports.check.windows": "Windows",
  "reports.check.mail": "Mail",
  "reports.check.air": "Airing",
  "reports.check.water": "Water",
  "reports.check.lights": "Lights",
  "reports.check.waste": "Waste",
  "reports.check.exterior": "Outside",
  "reports.check.attention": "Needs attention",
