...
const PT = {
  ...
  "login.title": "Entrar na Pulse",
  "login.lead": "Use o email da casa. Enviamos um código de 6 dígitos.",
  "login.email": "Email",
  "login.emailPlaceholder": "grace.l@example.com",
  ...
  "login.codeHint": "Expira em 5 minutos.",
  ...
  "laro.alerted": "A Laro já foi avisada.",
  "laro.near": "A Laro está por perto.",
  "laro.alertBody": "A equipa já tem o mesmo alerta. Se quiser falar com alguém no terreno, use o WhatsApp.",
  "laro.okBody": "Se algo não estiver certo, a equipa recebe o alerta ao mesmo tempo. Pode falar connosco agora.",
  "laro.whatsapp": "Falar no WhatsApp",
...
const EN: Record<CasaTextKey, string> = {
  ...
  "login.codeHint": "Expires in 5 minutes.",
  ...
  "laro.alerted": "Laro has already been notified.",
  "laro.near": "Laro is nearby.",
  "laro.alertBody": "The team already has the same alert. If you want to talk to someone on the ground, use WhatsApp.",
  "laro.okBody": "If something is not right, the team gets the alert at the same time. You can talk to us now.",
  "laro.whatsapp": "Chat on WhatsApp",
